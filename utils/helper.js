...
/**
 * Removes the undesired wrapper around the target element.
 * @param {HTMLElement} element - The parent element containing the undesired wrapper.
...
export function removeOuterElementLayer(element, targetSelector) {
  ...
  if (targetElement) {
    ...
    if (parent && parent instanceof HTMLElement) {
      ...
      console.error('Parent node is not valid or does not exist');
    }
  } else {
